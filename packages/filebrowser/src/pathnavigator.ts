...
export class PathNavigator extends Widget {
  ...
  private _navigateSuggestions(direction: 1 | -1): void {
    ...
    if (path) {
      // It is tempting to append / here, though not appending it allows us to use
      // this key (`/`) as committing navigation in the pathnavigator and keep typing,
      // and showing completion while Enter/Return validate the breadcrumb level.
      // Appending / here feels awkward when used in practice.
